...
var RoleWhere = struct {
	...
	WorkspaceID: whereHelperint{field: "`roles`.`workspace_id`"},
}
...
var (
	roleAllColumns            = []string{"id", "role_name", "workspace_id"}
	roleColumnsWithoutDefault = []string{"id", "role_name", "workspace_id"}
...
func (o *Role) Workspace(mods ...qm.QueryMod) workspaceQuery {
...
func (o *Role) RoleMethods(mods ...qm.QueryMod) roleMethodQuery {
	...
	queryMods = append(queryMods,
		qm.Where("`role_methods`.`role_id`=?", o.ID),
	)
...
func (o *Role) UserWorkspaces(mods ...qm.QueryMod) userWorkspaceQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("`user_workspaces`.`role_id`=?", o.ID),
	)
...
func (roleL) LoadWorkspace(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
...
func (roleL) LoadRoleMethods(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
	...
	query := NewQuery(
		...
		qm.WhereIn(`role_methods.role_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (roleL) LoadUserWorkspaces(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
	...
	query := NewQuery(
		...
		qm.WhereIn(`user_workspaces.role_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetWorkspace of the role to the related item.
// Sets o.R.Workspace to related.
// Adds o to related.R.Roles.
func (o *Role) SetWorkspace(ctx context.Context, exec boil.ContextExecutor, insert bool, related *Workspace) error {
	var err error
	if insert {
...
func (o *Role) AddRoleMethods(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*RoleMethod) error {
	var err error
...
// Sets related.R.Role appropriately.
func (o *Role) AddUserWorkspaces(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserWorkspace) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.RoleID = o.ID
