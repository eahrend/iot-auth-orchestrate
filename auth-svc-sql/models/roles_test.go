...
func testRoleToManyRoleMethods(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := RoleSlice{&a}
	if err = a.L.LoadRoleMethods(ctx, tx, false, (*[]*Role)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testRoleToManyUserWorkspaces(t *testing.T) {
	var err error
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	slice := RoleSlice{&a}
	if err = a.L.LoadUserWorkspaces(ctx, tx, false, (*[]*Role)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testRoleToManyAddOpRoleMethods(t *testing.T) {
	var err error
...
func testRoleToManyAddOpUserWorkspaces(t *testing.T) {
	var err error
...
func testRoleToOneWorkspaceUsingWorkspace(t *testing.T) {
	ctx := context.Background()
	tx := MustTx(boil.BeginTx(ctx, nil))
	defer func() { _ = tx.Rollback() }()
	...
	if err = local.L.LoadWorkspace(ctx, tx, false, (*[]*Role)(&slice), nil); err != nil {
		t.Fatal(err)
	}
...
func testRoleToOneSetOpWorkspaceUsingWorkspace(t *testing.T) {
	var err error
...
var (
	roleDBTypes = map[string]string{`ID`: `int`, `RoleName`: `varchar`, `WorkspaceID`: `int`}
	_           = bytes.MinRead
)
